...
namespace OpcReader
{
    ...
    public class Program
    {
        ...
        /// </summary>
        public const string ProgramName = "OpcReader";
        ...
        /// </summary>
        public static string DefaultEndpointUrl { get; set; } = "opc.tcp://localhost:50000";
        ...
        private static bool isCsvWriterInitialized = false;

        public static bool HaveToWriteCsv => _csvFileName != "";
        public static CsvWriter CsvWriter()
        {
            if (!isCsvWriterInitialized)
            {
                Logger.Debug("Initializing Program.CsvWriter...");
                StreamWriter writer = new StreamWriter(_csvFileName);
                csvWriter = new CsvWriter(writer, System.Globalization.CultureInfo.InvariantCulture);
                csvWriter.Configuration.HasHeaderRecord = false;
                isCsvWriterInitialized = true;
            }
            return csvWriter;
        }
    }
